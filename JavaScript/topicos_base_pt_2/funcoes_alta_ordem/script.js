...
const m1 = list1.map(dobro); // basta passar o nome da funcao
...
// --------------------------------------------------------------------------------------------------------------
// filter: retorna uma nova coleção contendo apenas aqueles elementos da coleção original que satisfazem um dado predicado (ALGO QUE RETORNA T OU F)
...
const r2 = list2.reduce(soma, 0); // colecoes vazias requerem um elemento neutro (valor cumulativo inicial)
...
const s2 = [...nomes].sort(comparacaoPorTamanho);
console.log(s2);
console.log(nomes);

// SPREAD
// cria um clone do vetor e ordena o clone
